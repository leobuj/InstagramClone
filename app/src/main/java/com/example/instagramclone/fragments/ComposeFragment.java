...
public class ComposeFragment extends Fragment {
    ...
    public static final String TAG = "inside ComposeFragment";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ibFeed = view.findViewById(R.id.ibFeed);
        etDescription = view.findViewById(R.id.etDescription);
        btnCaptureImage = view.findViewById(R.id.btnTakePicture);
        btnSubmit = view.findViewById(R.id.btnSubmit);
        ivSubmit = view.findViewById(R.id.ivSubmittedPicture);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(photoFile == null || ivSubmit.getDrawable() == null){
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                ivSubmit.setImageBitmap(takenImage);
